...
class Chart extends StatelessWidget {
  ...
  List<Map<String, Object>> get groupedTransationsValues {
  ...
  double get totalSpending {
    return groupedTransationsValues.fold(0.0, (sum, item) {
  ...
  Widget build(BuildContext context) {
    print(groupedTransationsValues);
    return Card(
      elevation: 6,
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: groupedTransationsValues.map((data) {
            return Flexible(
                fit: FlexFit.tight,            
